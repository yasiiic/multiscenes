...
public void initialize(SEResourceCache rsc) {
        ...
        rsc.prepare_image("image4","earth",get_scene_width(), get_scene_height());
        image = add_sprite_for_image(SEImage.for_resource("image4"));
        rsc.prepare_font("myfont","arial bold color=black", 50);
        text1 = add_sprite_for_text("M", "myfont");
        text1.move(0.9*get_scene_width(),0.75*get_scene_height());
        text2 = add_sprite_for_text("S2", "myfont");
        text2.move(0.9*get_scene_width(),0.8*get_scene_height());
        text3 = add_sprite_for_text("S3", "myfont");
        text3.move(0.9*get_scene_width(),0.85*get_scene_height());
        text4 = add_sprite_for_text("S4", "myfont");
